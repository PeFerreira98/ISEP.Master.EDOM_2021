 ...
 * @generated
 */
public class UserAttributeImpl extends MinimalEObjectImpl.Container implements UserAttribute {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.USER_ATTRIBUTE__NAME, oldName,
					name));
	}
	...
	public void setType(AttributeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.USER_ATTRIBUTE__TYPE, oldType,
					type));
	}
	...
	public boolean nameMustBegreaterThan1Char(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "UserAttribute::nameMustBegreaterThan1Char";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					Edom204epsilonPackage.Literals.USER_ATTRIBUTE___NAME_MUST_BEGREATER_THAN1_CHAR__DIAGNOSTICCHAIN_MAP);
	...
	public boolean nameMustHaveName(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "UserAttribute::nameMustHaveName";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					Edom204epsilonPackage.Literals.USER_ATTRIBUTE___NAME_MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, Edom204epsilonTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean symbol_0;
			if (le) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Edom204epsilonPackage.USER_ATTRIBUTE___NAME_MUST_BEGREATER_THAN1_CHAR__DIAGNOSTICCHAIN_MAP:
			return nameMustBegreaterThan1Char((DiagnosticChain) arguments.get(0),
					(Map<Object, Object>) arguments.get(1));
		case Edom204epsilonPackage.USER_ATTRIBUTE___NAME_MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP:
