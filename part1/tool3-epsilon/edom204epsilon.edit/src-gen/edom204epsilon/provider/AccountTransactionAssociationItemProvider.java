 ...
 * @generated
 */
public class AccountTransactionAssociationItemProvider extends ItemProviderAdapter
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_AccountTransactionAssociation_name_feature",
						"_UI_AccountTransactionAssociation_type"),
				Edom204epsilonPackage.Literals.ACCOUNT_TRANSACTION_ASSOCIATION__NAME, true, false, false,
	...
	protected void addAccountspecPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_AccountTransactionAssociation_accountspec_feature",
						"_UI_AccountTransactionAssociation_type"),
				Edom204epsilonPackage.Literals.ACCOUNT_TRANSACTION_ASSOCIATION__ACCOUNTSPEC, true, false, true, null,
				null, null));
	}
	...
	protected void addTransactionspecPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AccountTransactionAssociation_transactionspec_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_AccountTransactionAssociation_transactionspec_feature",
								"_UI_AccountTransactionAssociation_type"),
						Edom204epsilonPackage.Literals.ACCOUNT_TRANSACTION_ASSOCIATION__TRANSACTIONSPEC, true, false,
						true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_AccountTransactionAssociation_type")
