...
public class ModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Edom204epsilonPackage.Literals.MODEL__NAME, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Edom204epsilonPackage.Literals.MODEL__USERSPEC,
				Edom204epsilonFactory.eINSTANCE.createUserSpec()));

		newChildDescriptors.add(createChildParameter(Edom204epsilonPackage.Literals.MODEL__ACCOUNTSPEC,
				Edom204epsilonFactory.eINSTANCE.createAccountSpec()));

		newChildDescriptors.add(createChildParameter(Edom204epsilonPackage.Literals.MODEL__TRANSACTIONSPEC,
				Edom204epsilonFactory.eINSTANCE.createTransactionSpec()));

		newChildDescriptors.add(createChildParameter(Edom204epsilonPackage.Literals.MODEL__USERACCOUNTASSOCIATION,
				Edom204epsilonFactory.eINSTANCE.createUserAccountAssociation()));

		newChildDescriptors
				.add(createChildParameter(Edom204epsilonPackage.Literals.MODEL__ACCOUNTTRANSACTIONASSOCIATION,
