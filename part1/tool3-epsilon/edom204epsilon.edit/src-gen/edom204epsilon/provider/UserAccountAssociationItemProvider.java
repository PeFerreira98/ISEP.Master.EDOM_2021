 ...
 * @generated
 */
public class UserAccountAssociationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UserAccountAssociation_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UserAccountAssociation_name_feature",
								"_UI_UserAccountAssociation_type"),
						Edom204epsilonPackage.Literals.USER_ACCOUNT_ASSOCIATION__NAME, true, false, false,
	...
	protected void addUserspecPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UserAccountAssociation_userspec_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UserAccountAssociation_userspec_feature",
								"_UI_UserAccountAssociation_type"),
						Edom204epsilonPackage.Literals.USER_ACCOUNT_ASSOCIATION__USERSPEC, true, false, true, null,
						null, null));
	}
	...
	protected void addAccountspecPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UserAccountAssociation_accountspec_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_UserAccountAssociation_accountspec_feature", "_UI_UserAccountAssociation_type"),
						Edom204epsilonPackage.Literals.USER_ACCOUNT_ASSOCIATION__ACCOUNTSPEC, true, false, true, null,
						null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_UserAccountAssociation_type")
