...
namespace Empresa.MoneyManagerModel
{
	...
	/// </remarks>
	public partial class MoneyManagerModelHelpKeywordHelper : MoneyManagerModelHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MoneyManagerModelHelpKeywordHelper.
		/// </summary>
		protected MoneyManagerModelHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MoneyManagerModelHelpKeywordHelper.
		/// </summary>
		public static MoneyManagerModelHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MoneyManagerModelHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MoneyManagerModelHelpKeywordHelperBase.
		/// </summary>
		protected MoneyManagerModelHelpKeywordHelperBase()
			: base() { }
