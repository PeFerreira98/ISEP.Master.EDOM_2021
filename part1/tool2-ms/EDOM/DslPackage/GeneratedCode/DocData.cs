...
namespace Empresa.MoneyManagerModel
{
	...
	/// </summary>
	internal partial class MoneyManagerModelDocData : MoneyManagerModelDocDataBase
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelDocData.
		/// </summary>
		public MoneyManagerModelDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a MoneyManagerModel document in memory.
	/// </summary>
	internal abstract partial class MoneyManagerModelDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new MoneyManagerModelDocDataBase.
		/// </summary>
		protected MoneyManagerModelDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(MoneyManagerModelExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Empresa.MoneyManagerModel.Model modelRoot = null;
			...
			global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Empresa.MoneyManagerModel.MoneyManagerModelSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Empresa.MoneyManagerModel.Model modelRoot = (global::Empresa.MoneyManagerModel.Model)this.RootElement;
			...
			{
				global::Empresa.MoneyManagerModel.MoneyManagerModelDiagram diagram = diagrams[0] as global::Empresa.MoneyManagerModel.MoneyManagerModelDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Empresa.MoneyManagerModel.MoneyManagerModelSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Empresa.MoneyManagerModel.MoneyManagerModelSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Empresa.MoneyManagerModel.MoneyManagerModelDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Empresa.MoneyManagerModel.MoneyManagerModelSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Empresa.MoneyManagerModel.Model modelRoot = this.RootElement as global::Empresa.MoneyManagerModel.Model;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Empresa.MoneyManagerModel.MoneyManagerModelSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
