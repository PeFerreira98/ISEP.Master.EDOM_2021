...
namespace Empresa.MoneyManagerModel
{
	...
	/// </summary>
	internal partial class MoneyManagerModelDocView : MoneyManagerModelDocViewBase
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelDocView.
		/// </summary>
		public MoneyManagerModelDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MoneyManagerModelDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelDocView.
		/// </summary>
		protected MoneyManagerModelDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MoneyManagerModelDocDataBase docData = this.DocData as MoneyManagerModelDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MoneyManagerModelDocViewBase should be an MoneyManagerModelDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Empresa.MoneyManagerModel.MoneyManagerModelDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Empresa.MoneyManagerModel.MoneyManagerModelDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Empresa.MoneyManagerModel.MoneyManagerModelToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Empresa.MoneyManagerModel.MoneyManagerModelToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MoneyManagerModelDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Empresa.MoneyManagerModel.MoneyManagerModelHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Empresa.MoneyManagerModel.MoneyManagerModelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Empresa.MoneyManagerModel.MoneyManagerModelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
