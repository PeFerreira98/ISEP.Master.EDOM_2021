 ...
 * @generated
 */
public class TransactionSpecNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TransactionSpecNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Edom204epsilonParserProvider.getParser(Edom204epsilonElementTypes.TransactionSpec_2004,
					getParserElement(), Edom204epsilonVisualIDRegistry
							.getType(edom204epsilon.diagram.edit.parts.TransactionSpecNameEditPart.VISUAL_ID));
		}
		return parser;
	}
