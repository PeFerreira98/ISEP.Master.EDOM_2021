...
import edom204epsilon.diagram.edit.commands.Edom204epsilonCreateShortcutDecorationsCommand;
import edom204epsilon.diagram.edit.policies.ModelCanonicalEditPolicy;
import edom204epsilon.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Edom204epsilon"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(Edom204epsilonVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new Edom204epsilonCreateShortcutDecorationsCommand(
