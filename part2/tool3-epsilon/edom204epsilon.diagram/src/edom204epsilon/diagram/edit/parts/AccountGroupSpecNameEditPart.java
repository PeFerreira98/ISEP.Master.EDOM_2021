...
import edom204epsilon.diagram.edit.policies.Edom204epsilonTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AccountGroupSpecNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AccountGroupSpecNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new Edom204epsilonTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return Edom204epsilonElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Edom204epsilonParserProvider.getParser(Edom204epsilonElementTypes.AccountGroupSpec_2001,
					getParserElement(), Edom204epsilonVisualIDRegistry
							.getType(edom204epsilon.diagram.edit.parts.AccountGroupSpecNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					Edom204epsilonEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
