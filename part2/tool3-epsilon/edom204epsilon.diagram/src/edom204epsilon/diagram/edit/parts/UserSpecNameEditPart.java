 ...
 * @generated
 */
public class UserSpecNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserSpecNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Edom204epsilonParserProvider.getParser(Edom204epsilonElementTypes.UserSpec_2002,
					getParserElement(), Edom204epsilonVisualIDRegistry
							.getType(edom204epsilon.diagram.edit.parts.UserSpecNameEditPart.VISUAL_ID));
		}
		return parser;
	}
