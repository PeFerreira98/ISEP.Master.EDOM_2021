 ...
 * @generated
 */
public class AccountSpecNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AccountSpecNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Edom204epsilonParserProvider.getParser(Edom204epsilonElementTypes.AccountSpec_2003,
					getParserElement(), Edom204epsilonVisualIDRegistry
							.getType(edom204epsilon.diagram.edit.parts.AccountSpecNameEditPart.VISUAL_ID));
		}
		return parser;
	}
