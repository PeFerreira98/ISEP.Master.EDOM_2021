 ...
 * @generated
 */
public class CategorySpecNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CategorySpecNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Edom204epsilonParserProvider.getParser(Edom204epsilonElementTypes.CategorySpec_2005,
					getParserElement(), Edom204epsilonVisualIDRegistry
							.getType(edom204epsilon.diagram.edit.parts.CategorySpecNameEditPart.VISUAL_ID));
		}
		return parser;
	}
