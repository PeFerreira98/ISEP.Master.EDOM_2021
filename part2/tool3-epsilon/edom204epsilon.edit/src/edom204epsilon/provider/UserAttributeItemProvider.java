...
/**
 * This is the item provider adapter for a {@link edom204epsilon.UserAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserAttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttribute_name_feature", "_UI_UserAttribute_type"),
				 Edom204epsilonPackage.Literals.USER_ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserAttribute_cardinalityMin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttribute_cardinalityMin_feature", "_UI_UserAttribute_type"),
				 Edom204epsilonPackage.Literals.USER_ATTRIBUTE__CARDINALITY_MIN,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserAttribute_cardinalityMax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttribute_cardinalityMax_feature", "_UI_UserAttribute_type"),
				 Edom204epsilonPackage.Literals.USER_ATTRIBUTE__CARDINALITY_MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UserAttribute_type") :
