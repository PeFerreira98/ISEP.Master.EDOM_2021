 ...
 * @generated
 */
public class AccountSpecItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountSpec_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountSpec_name_feature", "_UI_AccountSpec_type"),
				 Edom204epsilonPackage.Literals.ACCOUNT_SPEC__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountSpec_cardinalityMin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountSpec_cardinalityMin_feature", "_UI_AccountSpec_type"),
				 Edom204epsilonPackage.Literals.ACCOUNT_SPEC__CARDINALITY_MIN,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountSpec_cardinalityMax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountSpec_cardinalityMax_feature", "_UI_AccountSpec_type"),
				 Edom204epsilonPackage.Literals.ACCOUNT_SPEC__CARDINALITY_MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((AccountSpec)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AccountSpec_type") :
			getString("_UI_AccountSpec_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Edom204epsilonPackage.Literals.ACCOUNT_SPEC__ACCOUNTATTRIBUTE,
