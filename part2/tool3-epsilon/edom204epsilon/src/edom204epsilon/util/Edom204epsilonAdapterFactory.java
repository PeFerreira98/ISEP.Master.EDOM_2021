...
public class Edom204epsilonAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Edom204epsilonSwitch<Adapter> modelSwitch =
		new Edom204epsilonSwitch<Adapter>() {
			@Override
			public Adapter caseModel(Model object) {
				return createModelAdapter();
			}
			@Override
			public Adapter caseAccountGroupSpec(AccountGroupSpec object) {
				return createAccountGroupSpecAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edom204epsilon.AccountGroupSpec <em>Account Group Spec</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
