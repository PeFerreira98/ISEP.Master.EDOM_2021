 ...
 *   <li>{@link edom204epsilon.impl.TransactionAttributeImpl#getCardinalityMin <em>Cardinality Min</em>}</li>
 *   <li>{@link edom204epsilon.impl.TransactionAttributeImpl#getCardinalityMax <em>Cardinality Max</em>}</li>
 *   <li>{@link edom204epsilon.impl.TransactionAttributeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionAttributeImpl extends EObjectImpl implements TransactionAttribute {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.TRANSACTION_ATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setCardinalityMin(int newCardinalityMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.TRANSACTION_ATTRIBUTE__CARDINALITY_MIN, oldCardinalityMin, cardinalityMin));
	}
	...
	public void setCardinalityMax(int newCardinalityMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.TRANSACTION_ATTRIBUTE__CARDINALITY_MAX, oldCardinalityMax, cardinalityMax));
	}
