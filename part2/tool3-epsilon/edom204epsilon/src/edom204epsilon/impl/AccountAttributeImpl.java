 ...
 * @generated
 */
public class AccountAttributeImpl extends EObjectImpl implements AccountAttribute {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.ACCOUNT_ATTRIBUTE__NAME, oldName, name));
	}
