 ...
 * </p>
 * <ul>
 *   <li>{@link edom204epsilon.impl.UserSpecImpl#getName <em>Name</em>}</li>
 *   <li>{@link edom204epsilon.impl.UserSpecImpl#getCardinalityMin <em>Cardinality Min</em>}</li>
 *   <li>{@link edom204epsilon.impl.UserSpecImpl#getCardinalityMax <em>Cardinality Max</em>}</li>
 *   <li>{@link edom204epsilon.impl.UserSpecImpl#getUserattribute <em>Userattribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserSpecImpl extends EObjectImpl implements UserSpec {
	/**
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "userName";
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.USER_SPEC__NAME, oldName, name));
	}
	...
	public void setCardinalityMin(int newCardinalityMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.USER_SPEC__CARDINALITY_MIN, oldCardinalityMin, cardinalityMin));
	}
	...
	public void setCardinalityMax(int newCardinalityMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edom204epsilonPackage.USER_SPEC__CARDINALITY_MAX, oldCardinalityMax, cardinalityMax));
	}
	...
	public EList<UserAttribute> getUserattribute() {
		if (userattribute == null) {
			userattribute = new EObjectContainmentEList<UserAttribute>(UserAttribute.class, this, Edom204epsilonPackage.USER_SPEC__USERATTRIBUTE);
		}
