...
namespace Empresa.MoneyManagerModel
{
	...
	/// </summary>
	internal partial class MoneyManagerModelCommandSet : MoneyManagerModelCommandSetBase
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelCommandSet.
		/// </summary>
		public MoneyManagerModelCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MoneyManagerModelCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelCommandSetBase.
		/// </summary>
		protected MoneyManagerModelCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMoneyManagerModelExplorerCommand,
				typeof(MoneyManagerModelEditorFactory).GUID);
		...
		{
			MoneyManagerModelExplorerToolWindow explorer = this.MoneyManagerModelExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentMoneyManagerModelDocData != null && this.CurrentMoneyManagerModelDocData.Store != null)
			{
				this.CurrentMoneyManagerModelDocData.ValidationController.Validate(this.CurrentMoneyManagerModelDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentMoneyManagerModelDocData != null && this.CurrentMoneyManagerModelDocData.Store != null)
			{
				...
				this.CurrentMoneyManagerModelDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected MoneyManagerModelDocData CurrentMoneyManagerModelDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MoneyManagerModelDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MoneyManagerModelDocView CurrentMoneyManagerModelDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MoneyManagerModelDocView;
			}
		}
		...
		/// </summary>
		protected MoneyManagerModelExplorerToolWindow MoneyManagerModelExplorerToolWindow
		{
			get
			{
				MoneyManagerModelExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MoneyManagerModelExplorerToolWindow), true) as MoneyManagerModelExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MoneyManagerModelExplorerToolWindow explorerWindow = this.MoneyManagerModelExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MoneyManagerModelClipboardCommandSet : MoneyManagerModelClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelClipboardCommandSet.
		/// </summary>
		public MoneyManagerModelClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MoneyManagerModelClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MoneyManagerModelClipboardCommandSetBase.
		/// </summary>
		protected MoneyManagerModelClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
